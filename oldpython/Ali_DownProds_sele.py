...
def downProd(prod_id, url):
    ...
    try:
        ...
        try:
            dls =browser.find_elements_by_class_name('ui-attr-list util-clearfix')
            #("//div[@id='product-desc']/div[1]/div/dl[@class='ui-attr-list util-clearfix']")
            for dl in dls:
        ...
        #all pics
        divs = browser.find_elements_by_xpath("//div[@id='custom-description']/div[@class='ui-box-body']")
        for div in divs:
            print div.text
